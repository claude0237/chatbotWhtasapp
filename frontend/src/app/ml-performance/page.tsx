  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">ML Performance Dashboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">ML Models</h2>
            {loading ? (
              <div>Loading...</div>
            ) : models.length === 0 ? (
          ...
          {/* Evaluation Panel */}
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Model Evaluation</h2>
            
            {!selectedModel ? (
              <div className="text-gray-500">Select a model to evaluate</div>
            ) : (
              <div className="space-y-4">
                <div>
